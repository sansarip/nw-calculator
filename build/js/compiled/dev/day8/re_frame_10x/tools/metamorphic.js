...
return cljs.core.filter.call(null,(function (p1__33965_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__33965_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__33965_SHARP_) <= ending)));
}));
});
...
return cljs.core.map.call(null,day8.re_frame_10x.tools.metamorphic.summarise_event,match);
});
...
var G__33966 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
var and__4210__auto__ = cljs.core.get_in.call(null,sub,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("sub","traits","sub/traits",1778340671),new cljs.core.Keyword(null,"unchanged?","unchanged?",1212001763)], null));
if(cljs.core.truth_(and__4210__auto__)){
return ((cljs.core.not_any_QMARK_.call(null,(function (p1__33968_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__33968_SHARP_);
...
return ((day8.re_frame_10x.tools.metamorphic.run_queue_QMARK_.call(null,event)) || (day8.re_frame_10x.tools.metamorphic.event_run_QMARK_.call(null,event)));
});
/**
...
return ((day8.re_frame_10x.tools.metamorphic.run_queue_QMARK_.call(null,event)) || (((day8.re_frame_10x.tools.metamorphic.event_run_QMARK_.call(null,event)) && ((!(day8.re_frame_10x.tools.metamorphic.run_queue_QMARK_.call(null,new cljs.core.Keyword(null,"previous-event","previous-event",-726928509).cljs$core$IFn$_invoke$arity$1(state))))))));
});
...
return cljs.core.assoc.call(null,((no_match_QMARK_)?((day8.re_frame_10x.tools.metamorphic.start_of_epoch_QMARK_.call(null,event))?cljs.core.assoc.call(null,state,new cljs.core.Keyword(null,"current-match","current-match",-551498177),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [event], null)):state):((day8.re_frame_10x.tools.metamorphic.quiescent_QMARK_.call(null,event))?cljs.core.assoc.call(null,cljs.core.update.call(null,state,new cljs.core.Keyword(null,"partitions","partitions",602979514),cljs.core.conj,cljs.core.conj.call(null,current_match,event)),new cljs.core.Keyword(null,"current-match","current-match",-551498177),null):((day8.re_frame_10x.tools.metamorphic.start_of_epoch_and_prev_end_QMARK_.call(null,event,state))?cljs.core.assoc.call(null,cljs.core.update.call(null,state,new cljs.core.Keyword(null,"partitions","partitions",602979514),cljs.core.conj,cljs.core.conj.call(null,current_match,previous_event)),new cljs.core.Keyword(null,"current-match","current-match",-551498177),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [event], null)):((day8.re_frame_10x.tools.metamorphic.event_run_QMARK_.call(null,event))?cljs.core.update.call(null,state,new cljs.core.Keyword(null,"current-match","current-match",-551498177),cljs.core.conj,event):state
...
return cljs.core.first.call(null,cljs.core.filter.call(null,day8.re_frame_10x.tools.metamorphic.event_run_QMARK_,match));
});
...
return cljs.core.assoc_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some.call(null,(function (p1__33969_SHARP_){
return cljs.core._EQ_.call(null,app_db_id,p1__33969_SHARP_);
...
}),initial_state,cljs.core.filter.call(null,day8.re_frame_10x.tools.metamorphic.subscription_re_run_QMARK_,filtered_traces));
});
/**
...
})),cljs.core.map.call(null,(function (p__33970){
var vec__33971 = p__33970;
var k = cljs.core.nth.call(null,vec__33971,(0),null);
var v = cljs.core.nth.call(null,vec__33971,(1),null);
...
var new_state = (function (){var G__33974 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.call(null,state,reaction_id,(function (sub_state){
...
var second_pass = cljs.core.reduce.call(null,(function (all_state,p__33975){
var vec__33976 = p__33975;
var sub_id = cljs.core.nth.call(null,vec__33976,(0),null);
var sub_state = cljs.core.nth.call(null,vec__33976,(1),null);
...
var pre_epoch_traces = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,day8.re_frame_10x.tools.metamorphic.id_between_xf.call(null,(previous_id + (1)),(first_match_id - (1))),cljs.core.filter.call(null,day8.re_frame_10x.tools.metamorphic.subscription_QMARK_)),filtered_traces);
var epoch_traces = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,day8.re_frame_10x.tools.metamorphic.id_between_xf.call(null,first_match_id,last_match_id),cljs.core.filter.call(null,day8.re_frame_10x.tools.metamorphic.subscription_QMARK_)),filtered_traces);
...
var pre_epoch_state = day8.re_frame_10x.tools.metamorphic.process_sub_traces.call(null,day8.re_frame_10x.tools.metamorphic.reset_sub_state.call(null,reaction_state),pre_epoch_traces);
var epoch_state = day8.re_frame_10x.tools.metamorphic.process_sub_traces.call(null,day8.re_frame_10x.tools.metamorphic.reset_sub_state.call(null,pre_epoch_state),epoch_traces);
