...
day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.container.dom._STAR_injected_styles_STAR_ = cljs.core.atom.call(null,null);
}
...
return cljs.core.swap_BANG_.call(null,styles_container,cljs.core.update,id,(function day8$re_frame_10x$inlined_deps$spade$git_sha_93ef290$container$dom$update_BANG__$_update_injected_style(obj){
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(obj),css)){
} else {
day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.container.dom.perform_update_BANG_.call(null,obj,css);
}
...
var element = (function (){var G__35761 = document.createElement("style");
G__35761.setAttribute("spade-id",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id));
...
cljs.core.swap_BANG_.call(null,styles_container,cljs.core.assoc,id,obj);

return day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.container.dom.perform_update_BANG_.call(null,obj,css);
});
...
if(cljs.core.contains_QMARK_.call(null,cljs.core.deref.call(null,resolved_container),style_name)){
return day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.container.dom.update_BANG_.call(null,resolved_container,style_name,css);
} else {
var resolved_dom = (function (){var or__4212__auto__ = ((cljs.core.ifn_QMARK_.call(null,self__.target_dom))?self__.target_dom.call(null):null);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
return day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.container.dom.inject_BANG_.call(null,resolved_dom,resolved_container,style_name,css);
}
}));
...
return cljs.core._write.call(null,writer__4451__auto__,"day8.re-frame-10x.inlined-deps.spade.git-sha-93ef290.container.dom/DomStyleContainer");
}));
...
return day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.container.dom.create_container.call(null,null);
}));
...
return day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.container.dom.create_container.call(null,target_dom,(cljs.core.truth_(target_dom)?cljs.core.atom.call(null,null):null));
}));
...
return day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.container.dom.__GT_DomStyleContainer.call(null,target_dom,styles_container);
}));
