...
return cljs.core._write.call(null,writer__4451__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__10206 = o;
goog.object.set(G__10206,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__10207__delegate = function (args){
...
while (G__10208__i < G__10208__a.length) {G__10208__a[G__10208__i] = arguments[G__10208__i + 0]; ++G__10208__i;}
  args = new cljs.core.IndexedSeq(G__10208__a,0,null);
} 
return G__10207__delegate.call(this,args);};
G__10207.cljs$lang$maxFixedArity = 0;
G__10207.cljs$lang$applyTo = (function (arglist__10209){
var args = cljs.core.seq(arglist__10209);
return G__10207__delegate(args);
});
...
var G__10210 = o;
goog.object.set(G__10210,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10212__i < G__10212__a.length) {G__10212__a[G__10212__i] = arguments[G__10212__i + 0]; ++G__10212__i;}
  args = new cljs.core.IndexedSeq(G__10212__a,0,null);
} 
...
var G__10214 = props;
var G__10214__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10214,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10214);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10214__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__10215 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10215,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__10215;
}
})(),id_class);
...
var G__10216 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10216) {
case (0):
...
return cljs.core._write.call(null,writer__4451__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__10218 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10218,(0),null);
var id = cljs.core.nth.call(null,vec__10218,(1),null);
var className = cljs.core.nth.call(null,vec__10218,(2),null);
...
var temp__5757__auto___10221 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___10221 == null)){
} else {
var key_10222 = temp__5757__auto___10221;
(jsprops.key = key_10222);
}
...
var temp__5757__auto___10223 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___10223 == null)){
} else {
var key_10224 = temp__5757__auto___10223;
(jsprops.key = key_10224);
}
...
var jsprops = (function (){var or__4212__auto__ = reagent.impl.template.convert_prop_value.call(null,((hasprops)?props:null));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return ({});
...
var temp__5757__auto___10225 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___10225 == null)){
} else {
var key_10226 = temp__5757__auto___10225;
(jsprops.key = key_10226);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_.call(null,props)));
var jsprops = (function (){var or__4212__auto__ = reagent.impl.template.convert_props.call(null,((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return ({});
...
var temp__5757__auto___10227 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___10227 == null)){
} else {
var key_10228 = temp__5757__auto___10227;
(jsprops.key = key_10228);
}
...
var temp__5757__auto___10229 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___10229 == null)){
} else {
var key_10230 = temp__5757__auto___10229;
(jsprops.key = key_10230);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__10231_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__10231_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__10232 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__10232,(0),null);
var derefed = cljs.core.nth.call(null,vec__10232,(1),null);
...
break;
default:
var G__10237 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__10238 = compiler;
v = G__10237;
compiler = G__10238;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template10242 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template10242 = (function (opts,id,fn_to_element,parse_fn,meta10243){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template10242.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10244,meta10243__$1){
var self__ = this;
var _10244__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template10242(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta10243__$1));
}));

(reagent.impl.template.t_reagent$impl$template10242.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10244){
var self__ = this;
var _10244__$1 = this;
return self__.meta10243;
}));

(reagent.impl.template.t_reagent$impl$template10242.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template10242.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template10242.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template10242.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template10242.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template10242.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta10243","meta10243",-594919874,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template10242.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template10242.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template10242");

(reagent.impl.template.t_reagent$impl$template10242.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write.call(null,writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template10242");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template10242.
 */
reagent.impl.template.__GT_t_reagent$impl$template10242 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template10242(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta10243){
return (new reagent.impl.template.t_reagent$impl$template10242(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta10243));
});

}

return (new reagent.impl.template.t_reagent$impl$template10242(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
