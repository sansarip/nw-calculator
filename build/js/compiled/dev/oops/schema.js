...
var G__28243 = cljs.core.first.call(null,element_str);
switch (G__28243) {
case "?":
arr.push((1));
...
var G__28245 = cljs.core.next.call(null,items);
items = G__28245;
continue;
} else {
return null;
...
var G__28246 = cljs.core.next.call(null,items);
items = G__28246;
continue;
} else {
return null;
...
var G__28248 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__28248;
continue;
} else {
return true;
...
switch (G__28251) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,(function (p1__28249_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28249_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,(function (p1__28250_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28250_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28251)].join('')));
