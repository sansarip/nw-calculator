...
var and__4210__auto____$1 = (!(oops.helpers.is_prototype_QMARK_.call(null,f)));
...
var G__27975 = cljs.core.next.call(null,items);
items = G__27975;
continue;
} else {
return arr;
...
var x27976 = error;
(x27976.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x27976.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__27977 = Object.getPrototypeOf(o);
o = G__27977;
continue;
} else {
