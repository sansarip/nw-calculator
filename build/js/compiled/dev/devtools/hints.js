...
var reader = (function (){var or__4212__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4212__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (128);
...
var map__40372 = top_item;
var map__40372__$1 = cljs.core.__destructure_map.call(null,map__40372);
var file = cljs.core.get.call(null,map__40372__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40372__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40372__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40371){var _e = e40371;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___40373 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___40373)){
var seen_errors_40374 = temp__5751__auto___40373;
if(cljs.core.truth_(seen_errors_40374.has(self))){
} else {
seen_errors_40374.add(self);

var temp__5753__auto___40375 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___40375)){
var sense_40376 = temp__5753__auto___40375;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40376)].join(''));
} else {
}
}
} else {
