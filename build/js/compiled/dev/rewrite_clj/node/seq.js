...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k35466,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k35466,else__4464__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4484__auto__,p__35471){
var vec__35472 = p__35471;
var k__4485__auto__ = cljs.core.nth.call(null,vec__35472,(0),null);
var v__4486__auto__ = cljs.core.nth.call(null,vec__35472,(1),null);
...
return cljs.core.pr_sequential_writer.call(null,writer__4477__auto__,pr_pair__4479__auto__,"#rewrite-clj.node.seq.SeqNode{",", ","}",opts__4478__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"tag","tag",-1290361223),self__.tag],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),self__.wrap_fn],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),self__.wrap_length],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),self__.seq_fn],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"children","children",-940561982),self__.children],null))], null),self__.__extmap));
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__35465){
var self__ = this;
var G__35465__$1 = this;
return (new cljs.core.RecordIter((0),G__35465__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
return (580297420 ^ cljs.core.hash_unordered_coll.call(null,coll__4458__auto__));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this35467,other35468){
var self__ = this;
var this35467__$1 = this;
return (((!((other35468 == null)))) && ((((this35467__$1.constructor === other35468.constructor)) && (((cljs.core._EQ_.call(null,this35467__$1.tag,other35468.tag)) && (((cljs.core._EQ_.call(null,this35467__$1.wrap_fn,other35468.wrap_fn)) && (((cljs.core._EQ_.call(null,this35467__$1.wrap_length,other35468.wrap_length)) && (((cljs.core._EQ_.call(null,this35467__$1.seq_fn,other35468.seq_fn)) && (((cljs.core._EQ_.call(null,this35467__$1.children,other35468.children)) && (cljs.core._EQ_.call(null,this35467__$1.__extmap,other35468.__extmap)))))))))))))));
}));
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4472__auto__)),null));
}
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k35466){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k35466);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__35465){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__35476 = cljs.core.keyword_identical_QMARK_;
var expr__35477 = k__4470__auto__;
if(cljs.core.truth_(pred__35476.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__35477))){
return (new rewrite_clj.node.seq.SeqNode(G__35465,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35476.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__35477))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__35465,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35476.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__35477))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__35465,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35476.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__35477))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__35465,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35476.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__35477))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__35465,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4470__auto__,G__35465),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__35465){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__35465,self__.__extmap,self__.__hash));
}));
...
return cljs.core._write.call(null,writer__4506__auto__,"rewrite-clj.node.seq/SeqNode");
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__35469){
var extmap__4501__auto__ = (function (){var G__35479 = cljs.core.dissoc.call(null,G__35469,new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_.call(null,G__35469)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__35479);
} else {
return G__35479;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__35469),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__35469),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__35469),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__35469),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__35469),null,cljs.core.not_empty.call(null,extmap__4501__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode.call(null,new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__35482_SHARP_){
return cljs.core.apply.call(null,cljs.core.list,p1__35482_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode.call(null,new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__35483_SHARP_){
return cljs.core.apply.call(null,cljs.core.hash_map,p1__35483_SHARP_);
}),children);
});
