...
var rewrite_clj$node$protocols$Node$tag$dyn_35326 = (function (_){
...
return rewrite_clj$node$protocols$Node$tag$dyn_35326.call(null,_);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_35327 = (function (_){
var x__4509__auto__ = (((_ == null))?null:_);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_35327.call(null,_);
}
});

var rewrite_clj$node$protocols$Node$sexpr$dyn_35328 = (function (_){
var x__4509__auto__ = (((_ == null))?null:_);
...
return rewrite_clj$node$protocols$Node$sexpr$dyn_35328.call(null,_);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_35329 = (function (_){
var x__4509__auto__ = (((_ == null))?null:_);
...
return rewrite_clj$node$protocols$Node$length$dyn_35329.call(null,_);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_35330 = (function (_){
var x__4509__auto__ = (((_ == null))?null:_);
...
return rewrite_clj$node$protocols$Node$string$dyn_35330.call(null,_);
}
});
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_35331 = (function (_){
var x__4509__auto__ = (((_ == null))?null:_);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_35331.call(null,_);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_35332 = (function (_){
var x__4509__auto__ = (((_ == null))?null:_);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_35332.call(null,_);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_35333 = (function (_,children){
var x__4509__auto__ = (((_ == null))?null:_);
var m__4510__auto__ = (rewrite_clj.node.protocols.replace_children[goog.typeOf(x__4509__auto__)]);
if((!((m__4510__auto__ == null)))){
return m__4510__auto__.call(null,_,children);
} else {
var m__4508__auto__ = (rewrite_clj.node.protocols.replace_children["_"]);
if((!((m__4508__auto__ == null)))){
return m__4508__auto__.call(null,_,children);
} else {
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_35333.call(null,_,children);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_35334 = (function (_){
var x__4509__auto__ = (((_ == null))?null:_);
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_35334.call(null,_);
}
});
