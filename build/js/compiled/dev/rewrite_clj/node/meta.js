...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k35415,else__4464__auto__){
var self__ = this;
var this__4463__auto____$1 = this;
var G__35419 = k35415;
var G__35419__$1 = (((G__35419 instanceof cljs.core.Keyword))?G__35419.fqn:null);
switch (G__35419__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k35415,else__4464__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4484__auto__,p__35420){
var vec__35421 = p__35420;
var k__4485__auto__ = cljs.core.nth.call(null,vec__35421,(0),null);
var v__4486__auto__ = cljs.core.nth.call(null,vec__35421,(1),null);
...
return (1501447658 ^ cljs.core.hash_unordered_coll.call(null,coll__4458__auto__));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this35416,other35417){
var self__ = this;
var this35416__$1 = this;
return (((!((other35417 == null)))) && ((((this35416__$1.constructor === other35417.constructor)) && (((cljs.core._EQ_.call(null,this35416__$1.tag,other35417.tag)) && (((cljs.core._EQ_.call(null,this35416__$1.prefix,other35417.prefix)) && (((cljs.core._EQ_.call(null,this35416__$1.children,other35417.children)) && (cljs.core._EQ_.call(null,this35416__$1.__extmap,other35417.__extmap)))))))))));
}));
...
var self__ = this;
var ___$1 = this;
var vec__35424 = rewrite_clj.node.protocols.sexprs.call(null,self__.children);
var mta = cljs.core.nth.call(null,vec__35424,(0),null);
var data = cljs.core.nth.call(null,vec__35424,(1),null);
...
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4472__auto__)),null));
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k35415){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k35415);

}
}));

(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__35414){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__35429 = cljs.core.keyword_identical_QMARK_;
var expr__35430 = k__4470__auto__;
if(cljs.core.truth_(pred__35429.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__35430))){
return (new rewrite_clj.node.meta.MetaNode(G__35414,self__.prefix,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35429.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__35430))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,G__35414,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35429.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__35430))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,G__35414,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4470__auto__,G__35414),null));
}
}
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__35414){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,G__35414,self__.__extmap,self__.__hash));
}));
...
return cljs.core._write.call(null,writer__4506__auto__,"rewrite-clj.node.meta/MetaNode");
}));
 ...
 */
rewrite_clj.node.meta.map__GT_MetaNode = (function rewrite_clj$node$meta$map__GT_MetaNode(G__35418){
var extmap__4501__auto__ = (function (){var G__35432 = cljs.core.dissoc.call(null,G__35418,new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_.call(null,G__35418)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__35432);
} else {
return G__35432;
}
})();
return (new rewrite_clj.node.meta.MetaNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__35418),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__35418),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__35418),null,cljs.core.not_empty.call(null,extmap__4501__auto__),null));
});
