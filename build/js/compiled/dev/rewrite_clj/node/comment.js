...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k35600,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k35600,else__4464__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4484__auto__,p__35605){
var vec__35606 = p__35605;
var k__4485__auto__ = cljs.core.nth.call(null,vec__35606,(0),null);
var v__4486__auto__ = cljs.core.nth.call(null,vec__35606,(1),null);
...
return cljs.core.pr_sequential_writer.call(null,writer__4477__auto__,pr_pair__4479__auto__,"#rewrite-clj.node.comment.CommentNode{",", ","}",opts__4478__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"s","s",1705939918),self__.s],null))], null),self__.__extmap));
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__35599){
var self__ = this;
var G__35599__$1 = this;
return (new cljs.core.RecordIter((0),G__35599__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
return (495469178 ^ cljs.core.hash_unordered_coll.call(null,coll__4458__auto__));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this35601,other35602){
var self__ = this;
var this35601__$1 = this;
return (((!((other35602 == null)))) && ((((this35601__$1.constructor === other35602.constructor)) && (((cljs.core._EQ_.call(null,this35601__$1.s,other35602.s)) && (cljs.core._EQ_.call(null,this35601__$1.__extmap,other35602.__extmap)))))));
}));
...
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"s","s",1705939918),null], null), null),k__4472__auto__)){
...
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4472__auto__)),null));
}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k35600){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_.call(null,self__.__extmap,k35600);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__35599){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__35610 = cljs.core.keyword_identical_QMARK_;
var expr__35611 = k__4470__auto__;
if(cljs.core.truth_(pred__35610.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__35611))){
return (new rewrite_clj.node.comment.CommentNode(G__35599,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4470__auto__,G__35599),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__35599){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__35599,self__.__extmap,self__.__hash));
}));
...
return cljs.core._write.call(null,writer__4506__auto__,"rewrite-clj.node.comment/CommentNode");
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__35603){
var extmap__4501__auto__ = (function (){var G__35613 = cljs.core.dissoc.call(null,G__35603,new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_.call(null,G__35603)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__35613);
} else {
return G__35613;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__35603),null,cljs.core.not_empty.call(null,extmap__4501__auto__),null));
});
