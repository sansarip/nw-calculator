...
return cljs.core.reduce.call(null,(function (result,p__16662){
...
var vec__16666 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__16666,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__16666,(1),null);
var ab = cljs.core.nth.call(null,vec__16666,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_16672 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_16672.call(null,x);
}
});
...
return clojure$data$Diff$diff_similar$dyn_16673.call(null,a,b);
}
});
...
return (function (){var G__16677 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16677__$1)].join('')));
