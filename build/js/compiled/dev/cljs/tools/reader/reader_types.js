...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_10398 = (function (reader){
...
return m__4510__auto__.call(null,reader);
} else {
var m__4508__auto__ = (cljs.tools.reader.reader_types.read_char["_"]);
if((!((m__4508__auto__ == null)))){
return m__4508__auto__.call(null,reader);
} else {
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_10398.call(null,reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_10399 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_10399.call(null,reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_10400 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
var m__4510__auto__ = (cljs.tools.reader.reader_types.unread[goog.typeOf(x__4509__auto__)]);
if((!((m__4510__auto__ == null)))){
return m__4510__auto__.call(null,reader,ch);
} else {
var m__4508__auto__ = (cljs.tools.reader.reader_types.unread["_"]);
if((!((m__4508__auto__ == null)))){
return m__4508__auto__.call(null,reader,ch);
} else {
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_10400.call(null,reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_10401 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_10401.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_10402 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_10402.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_10403 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_10403.call(null,reader);
}
});
...
return cljs.core._write.call(null,writer__4451__auto__,"cljs.tools.reader.reader-types/StringReader");
}));
...
return cljs.core._write.call(null,writer__4451__auto__,"cljs.tools.reader.reader-types/NodeReadableReader");
}));
...
return cljs.core._write.call(null,writer__4451__auto__,"cljs.tools.reader.reader-types/PushbackReader");
}));
...
return cljs.core._write.call(null,writer__4451__auto__,"cljs.tools.reader.reader-types/IndexingPushbackReader");
}));
...
return cljs.core._write.call(null,writer__4451__auto__,"cljs.tools.reader.reader-types/SourceLoggingPushbackReader");
}));
...
var G__10414 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
var G__10415 = s.append(c);
c = G__10414;
s = G__10415;
continue;
}
