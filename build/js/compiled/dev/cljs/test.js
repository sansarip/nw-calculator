...
var G__27402 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__27402,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__27402;
}
}));
...
args__4824__auto__.push((arguments[i__4819__auto___27408]));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq27404){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27405,G__27406,seq27404__$2);
}));
...
var map__27411 = m;
var map__27411__$1 = cljs.core.__destructure_map.call(null,map__27411);
var file = cljs.core.get.call(null,map__27411__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__27411__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__27411__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__27410_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__27410_SHARP_));
 ...
 */
cljs.test.report = (function (){var method_table__4701__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var formatter_fn = (function (){var or__4212__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
var temp__5753__auto___27412 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___27412)){
var message_27413 = temp__5753__auto___27412;
cljs.core.println.call(null,message_27413);
} else {
}
...
var temp__5753__auto___27414 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___27414)){
var message_27415 = temp__5753__auto___27414;
cljs.core.println.call(null,message_27415);
} else {
}
...
var output_dir = "resources/public/js/compiled/dev";
var output_dir__$1 = (function (){var G__27416 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__27416,"/"].join('');
} else {
return G__27416;
}
})();
...
var G__27417 = exception.stack;
var G__27417__$1 = (((G__27417 == null))?null:clojure.string.split_lines.call(null,G__27417));
var G__27417__$2 = (((G__27417__$1 == null))?null:cljs.core.get.call(null,G__27417__$1,depth));
if((G__27417__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__27417__$2);
}
} else {
...
var vec__27418 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__27418,(0),null);
var column = cljs.core.nth.call(null,vec__27418,(1),null);
var vec__27421 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__27421,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__27421,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__27421,(2),null);
...
var m__$1 = (function (){var G__27424 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__27428 = (function (){var G__27427 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__27427);
} else {
return G__27427;
}
})();
...
return cljs.core.vary_meta.call(null,G__27429,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__27433 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__27433,(0),null);
var types = vec__27433;
...
return cljs.core.map.call(null,(function (p__27436){
var vec__27437 = p__27436;
var ns = cljs.core.nth.call(null,vec__27437,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__27437,(1),null);
return (function (){
...
var G__27440 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__27441 = cljs.core.seq.call(null,vars__$1);
var chunk__27442 = null;
var count__27443 = (0);
var i__27444 = (0);
while(true){
if((i__27444 < count__27443)){
var v = cljs.core._nth.call(null,chunk__27442,i__27444);
var temp__5753__auto___27446 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5753__auto___27446)){
var t_27447 = temp__5753__auto___27446;
each_fixture_fn.call(null,((function (seq__27441,chunk__27442,count__27443,i__27444,t_27447,temp__5753__auto___27446,v,each_fixture_fn,G__27440,G__27440__$1,env,once_fixtures,each_fixtures,vec__27437,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27447)));
});})(seq__27441,chunk__27442,count__27443,i__27444,t_27447,temp__5753__auto___27446,v,each_fixture_fn,G__27440,G__27440__$1,env,once_fixtures,each_fixtures,vec__27437,ns,vars__$1))
);
} else {
}
...
var temp__5753__auto__ = cljs.core.seq.call(null,seq__27441);
if(temp__5753__auto__){
var seq__27441__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27441__$1)){
var c__4638__auto__ = cljs.core.chunk_first.call(null,seq__27441__$1);
var G__27452 = cljs.core.chunk_rest.call(null,seq__27441__$1);
var G__27453 = c__4638__auto__;
var G__27454 = cljs.core.count.call(null,c__4638__auto__);
var G__27455 = (0);
seq__27441 = G__27452;
...
var v = cljs.core.first.call(null,seq__27441__$1);
var temp__5753__auto___27456__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5753__auto___27456__$1)){
var t_27457 = temp__5753__auto___27456__$1;
each_fixture_fn.call(null,((function (seq__27441,chunk__27442,count__27443,i__27444,t_27457,temp__5753__auto___27456__$1,v,seq__27441__$1,temp__5753__auto__,each_fixture_fn,G__27440,G__27440__$1,env,once_fixtures,each_fixtures,vec__27437,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27457)));
});})(seq__27441,chunk__27442,count__27443,i__27444,t_27457,temp__5753__auto___27456__$1,v,seq__27441__$1,temp__5753__auto__,each_fixture_fn,G__27440,G__27440__$1,env,once_fixtures,each_fixtures,vec__27437,ns,vars__$1))
);
} else {
}


var G__27458 = cljs.core.next.call(null,seq__27441__$1);
var G__27459 = null;
var G__27460 = (0);
var G__27461 = (0);
seq__27441 = G__27458;
chunk__27442 = G__27459;
count__27443 = G__27460;
i__27444 = G__27461;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27440__$1)].join('')));
