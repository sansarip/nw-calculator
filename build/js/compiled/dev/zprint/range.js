...
var G__38500 = (current_index + row_or_direction__$1);
var G__38501 = current_index;
var G__38502 = (tries + (1));
current_index = G__38500;
previous_index = G__38501;
tries = G__38502;
continue;
}
...
var G__38506 = ((cljs.core._EQ_.call(null,maybe_index,new cljs.core.Keyword(null,"before","before",-1633692388)))?cljs.core._:cljs.core._PLUS_).call(null,row_vec_index,((zprint.range.abs.call(null,(row_vec_index - previous_index)) / (2)) | (0)));
var G__38507 = row_vec_index;
var G__38508 = (tries + (1));
row_vec_index = G__38506;
previous_index = G__38507;
tries = G__38508;
continue;
...
var row_vec = (function (){try{return cljs.core.mapv.call(null,cljs.core.meta,edamame.core.parse_string_all.call(null,filestring,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"all","all",892129742),true,new cljs.core.Keyword(null,"features","features",-1146962336),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"clj","clj",-660495428),null,new cljs.core.Keyword(null,"cljs","cljs",1492417629),null], null), null),new cljs.core.Keyword(null,"read-cond","read-cond",1056899244),(function (expr){
return cljs.core.with_meta.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.meta.call(null,expr));
...
var row_vec__$1 = (cljs.core.truth_(row_vec)?cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.remove.call(null,cljs.core.nil_QMARK_,row_vec)):null);
var _ = (cljs.core.truth_(dbg_QMARK_)?cljs.core.prn.call(null,row_vec__$1):null);
var start_row_idx = (cljs.core.truth_(row_vec__$1)?zprint.range.find_row.call(null,row_vec__$1,(start__$1 + (1)),dbg_QMARK_):new cljs.core.Keyword(null,"fail","fail",1706214930));
var ___$1 = (cljs.core.truth_(dbg_QMARK_)?cljs.core.println.call(null,"expand-range-to-top-level start-row-idx:",start_row_idx,((typeof start_row_idx === 'number')?["row:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.call(null,row_vec__$1,start_row_idx)),"previous row:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.call(null,row_vec__$1,(function (){var x__4295__auto__ = (0);
var y__4296__auto__ = (start_row_idx - (1));
return ((x__4295__auto__ > y__4296__auto__) ? x__4295__auto__ : y__4296__auto__);
})()))].join(''):"")):null);
var actual_start = ((cljs.core._EQ_.call(null,start_row_idx,new cljs.core.Keyword(null,"fail","fail",1706214930)))?(-1):((((cljs.core._EQ_.call(null,start_row_idx,new cljs.core.Keyword(null,"before-beginning","before-beginning",485705715))) && ((!((start__$1 < (0)))))))?(0):((cljs.core._EQ_.call(null,start_row_idx,new cljs.core.Keyword(null,"before-beginning","before-beginning",485705715)))?(-1):((cljs.core._EQ_.call(null,start_row_idx,(0)))?(0):((cljs.core._EQ_.call(null,start_row_idx,new cljs.core.Keyword(null,"beyond-end","beyond-end",487000285)))?line_count:new cljs.core.Keyword(null,"end-row","end-row",-545103581).cljs$core$IFn$_invoke$arity$1(cljs.core.get.call(null,row_vec__$1,(start_row_idx - (1))))
)))));
...
var end_row_idx = (cljs.core.truth_(row_vec__$1)?zprint.range.find_row.call(null,row_vec__$1,(end__$2 + (1)),dbg_QMARK_):new cljs.core.Keyword(null,"fail","fail",1706214930));
var ___$2 = (cljs.core.truth_(dbg_QMARK_)?cljs.core.println.call(null,"expand-range-to-top-level end-row-idx:",end_row_idx,((typeof end_row_idx === 'number')?["row:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.call(null,row_vec__$1,end_row_idx))].join(''):"")):null);
var actual_end = ((((cljs.core._EQ_.call(null,end_row_idx,new cljs.core.Keyword(null,"fail","fail",1706214930))) || (cljs.core._EQ_.call(null,end_row_idx,new cljs.core.Keyword(null,"beyond-end","beyond-end",487000285)))))?line_count:((cljs.core._EQ_.call(null,end_row_idx,new cljs.core.Keyword(null,"before-beginning","before-beginning",485705715)))?new cljs.core.Keyword(null,"do-nothing","do-nothing",1030476282):(function (){var end_row = cljs.core.get.call(null,row_vec__$1,end_row_idx);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.take.call(null,before,lines),cljs.core.take.call(null,range,cljs.core.drop.call(null,before,lines)),cljs.core.take.call(null,after,cljs.core.drop.call(null,(before + range),lines))], null);
});
/**
...
var before_QMARK_ = (!(cljs.core.empty_QMARK_.call(null,before_lines)));
var before_lines__$1 = ((before_QMARK_)?clojure.string.join.call(null,"\n",before_lines):"");
var range_QMARK_ = (!(cljs.core.empty_QMARK_.call(null,range)));
var after_QMARK_ = (!(cljs.core.empty_QMARK_.call(null,after_lines)));
var after_lines__$1 = ((after_QMARK_)?clojure.string.join.call(null,"\n",after_lines):"");
