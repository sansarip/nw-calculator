...
return [(function (){var pred__10359 = cljs.core.instance_QMARK_;
var expr__10360 = reactive_val;
if(cljs.core.truth_(pred__10359.call(null,reagent.ratom.RAtom,expr__10360))){
return "ra";
} else {
if(cljs.core.truth_(pred__10359.call(null,reagent.ratom.RCursor,expr__10360))){
return "rc";
} else {
if(cljs.core.truth_(pred__10359.call(null,reagent.ratom.Reaction,expr__10360))){
return "rx";
} else {
if(cljs.core.truth_(pred__10359.call(null,reagent.ratom.Track,expr__10360))){
return "tr";
} else {
return "other";
}
