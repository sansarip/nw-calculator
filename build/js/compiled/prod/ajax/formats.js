...
var G__14967 = request;
var G__14968 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__14967,G__14968) : ajax.formats.get_format.call(null,G__14967,G__14968));
} else {
...
return cljs.core.some((function (p1__14969_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__14969_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__14970){
var map__14971 = p__14970;
var map__14971__$1 = cljs.core.__destructure_map(map__14971);
var request = map__14971__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14971__$1,cljs.core.cst$kw$response_DASH_format);
...
var fexpr__14972 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__14972.cljs$core$IFn$_invoke$arity$1 ? fexpr__14972.cljs$core$IFn$_invoke$arity$1(response) : fexpr__14972.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__14974){
var map__14975 = p__14974;
var map__14975__$1 = cljs.core.__destructure_map(map__14975);
var request = map__14975__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14975__$1,cljs.core.cst$kw$response_DASH_format);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__14973_SHARP_){
return ajax.formats.get_accept_entries(request,p1__14973_SHARP_);
