...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__14785){
...
var vec_key_encode = (function (){var G__14789 = (function (){var or__4212__auto__ = vec_strategy;
...
var G__14789__$1 = (((G__14789 instanceof cljs.core.Keyword))?G__14789.fqn:null);
switch (G__14789__$1) {
case "java":
return (function (k){
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14789__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__14791){
var vec__14792 = p__14791;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14792,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14792,(1),null);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__14797){
var map__14798 = p__14797;
var map__14798__$1 = cljs.core.__destructure_map(map__14798);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14798__$1,cljs.core.cst$kw$vec_DASH_strategy);
