...
var G__26400 = cljs.core.next(items);
items = G__26400;
continue;
} else {
return arr;
...
var x26401 = error;
(x26401.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x26401.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__26402 = Object.getPrototypeOf(o);
o = G__26402;
continue;
} else {
