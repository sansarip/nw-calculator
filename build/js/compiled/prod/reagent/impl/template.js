...
var G__14567 = o;
goog.object.set(G__14567,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__14568__delegate = function (args){
...
while (G__14569__i < G__14569__a.length) {G__14569__a[G__14569__i] = arguments[G__14569__i + 0]; ++G__14569__i;}
  args = new cljs.core.IndexedSeq(G__14569__a,0,null);
} 
return G__14568__delegate.call(this,args);};
G__14568.cljs$lang$maxFixedArity = 0;
G__14568.cljs$lang$applyTo = (function (arglist__14570){
var args = cljs.core.seq(arglist__14570);
return G__14568__delegate(args);
});
...
var G__14571 = o;
goog.object.set(G__14571,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__14573__i < G__14573__a.length) {G__14573__a[G__14573__i] = arguments[G__14573__i + 0]; ++G__14573__i;}
  args = new cljs.core.IndexedSeq(G__14573__a,0,null);
} 
...
var G__14575 = props;
var G__14575__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14575,cljs.core.cst$kw$id,id):G__14575);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14575__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__14576 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14576,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__14576;
}
})(),id_class);
...
var G__14577 = (cljs.core.count(argv) - first_child);
switch (G__14577) {
case (0):
...
break;
case (1):
var G__14578 = component;
var G__14579 = jsprops;
var G__14580 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__14578,G__14579,G__14580);
...
var vec__14582 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14582,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14582,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14582,(2),null);
...
var temp__5757__auto___14585 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___14585 == null)){
} else {
var key_14586 = temp__5757__auto___14585;
(jsprops.key = key_14586);
}
...
var temp__5757__auto___14589 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___14589 == null)){
} else {
var key_14590 = temp__5757__auto___14589;
(jsprops.key = key_14590);
}

var G__14587 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__14588 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__14587,G__14588);
});
/**
...
var temp__5757__auto___14591 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___14591 == null)){
} else {
var key_14592 = temp__5757__auto___14591;
(jsprops.key = key_14592);
}
...
var temp__5757__auto___14593 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___14593 == null)){
} else {
var key_14594 = temp__5757__auto___14593;
(jsprops.key = key_14594);
}
...
var temp__5757__auto___14595 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___14595 == null)){
} else {
var key_14596 = temp__5757__auto___14595;
(jsprops.key = key_14596);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14597_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__14597_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__14598 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14598,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14598,(1),null);
...
break;
default:
var G__14603 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__14604 = compiler;
v = G__14603;
compiler = G__14604;
continue;
...
var G__14605 = tag;
var G__14605__$1 = (((G__14605 instanceof cljs.core.Keyword))?G__14605.fqn:null);
switch (G__14605__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template14608 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template14608 = (function (opts,id,fn_to_element,parse_fn,meta14609){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template14608.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14610,meta14609__$1){
var self__ = this;
var _14610__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template14608(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta14609__$1));
}));

(reagent.impl.template.t_reagent$impl$template14608.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14610){
var self__ = this;
var _14610__$1 = this;
return self__.meta14609;
}));

(reagent.impl.template.t_reagent$impl$template14608.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template14608.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template14608.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template14608.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template14608.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template14608.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta14609], null);
}));

(reagent.impl.template.t_reagent$impl$template14608.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template14608.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template14608");

(reagent.impl.template.t_reagent$impl$template14608.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template14608");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template14608.
 */
reagent.impl.template.__GT_t_reagent$impl$template14608 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template14608(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14609){
return (new reagent.impl.template.t_reagent$impl$template14608(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14609));
});

}

return (new reagent.impl.template.t_reagent$impl$template14608(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
