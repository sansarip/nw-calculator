...
var G__13295 = o;
goog.object.set(G__13295,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13296__delegate = function (args){
...
while (G__13297__i < G__13297__a.length) {G__13297__a[G__13297__i] = arguments[G__13297__i + 0]; ++G__13297__i;}
  args = new cljs.core.IndexedSeq(G__13297__a,0,null);
} 
return G__13296__delegate.call(this,args);};
...
return G__13296__delegate(args);
});
...
var G__13299 = o;
goog.object.set(G__13299,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__13301__i < G__13301__a.length) {G__13301__a[G__13301__i] = arguments[G__13301__i + 0]; ++G__13301__i;}
  args = new cljs.core.IndexedSeq(G__13301__a,0,null);
} 
...
var G__13303 = props;
var G__13303__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13303,cljs.core.cst$kw$id,id):G__13303);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13303__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__13304 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13304,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__13304;
}
})(),id_class);
...
var G__13305 = (cljs.core.count(argv) - first_child);
switch (G__13305) {
case (0):
...
break;
case (1):
var G__13306 = component;
var G__13307 = jsprops;
var G__13308 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__13306,G__13307,G__13308);
...
var vec__13310 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13310,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13310,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13310,(2),null);
...
var temp__5757__auto___13313 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___13313 == null)){
} else {
var key_13314 = temp__5757__auto___13313;
(jsprops.key = key_13314);
}
...
var temp__5757__auto___13317 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___13317 == null)){
} else {
var key_13318 = temp__5757__auto___13317;
(jsprops.key = key_13318);
}

var G__13315 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__13316 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__13315,G__13316);
});
/**
...
var temp__5757__auto___13319 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___13319 == null)){
} else {
var key_13320 = temp__5757__auto___13319;
(jsprops.key = key_13320);
}
...
var temp__5757__auto___13321 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___13321 == null)){
} else {
var key_13322 = temp__5757__auto___13321;
(jsprops.key = key_13322);
}
...
var temp__5757__auto___13323 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___13323 == null)){
} else {
var key_13324 = temp__5757__auto___13323;
(jsprops.key = key_13324);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13325_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__13325_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__13326 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13326,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13326,(1),null);
...
break;
default:
var G__13331 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__13332 = compiler;
v = G__13331;
compiler = G__13332;
continue;
...
var G__13333 = tag;
var G__13333__$1 = (((G__13333 instanceof cljs.core.Keyword))?G__13333.fqn:null);
switch (G__13333__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template13336 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template13336 = (function (opts,id,fn_to_element,parse_fn,meta13337){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta13337 = meta13337;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template13336.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13338,meta13337__$1){
var self__ = this;
var _13338__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template13336(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta13337__$1));
}));

(reagent.impl.template.t_reagent$impl$template13336.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13338){
var self__ = this;
var _13338__$1 = this;
return self__.meta13337;
}));

(reagent.impl.template.t_reagent$impl$template13336.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template13336.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template13336.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template13336.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template13336.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template13336.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta13337], null);
}));

(reagent.impl.template.t_reagent$impl$template13336.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template13336.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template13336");

(reagent.impl.template.t_reagent$impl$template13336.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template13336");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template13336.
 */
reagent.impl.template.__GT_t_reagent$impl$template13336 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template13336(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta13337){
return (new reagent.impl.template.t_reagent$impl$template13336(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta13337));
});

}

return (new reagent.impl.template.t_reagent$impl$template13336(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
