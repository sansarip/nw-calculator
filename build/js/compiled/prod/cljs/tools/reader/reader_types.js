...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13499 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13499(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13500 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13500(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13501 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13501(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13502 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13502(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13503 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13503(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13504 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13504(reader);
}
});
...
var G__13515 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13516 = s.append(c);
c = G__13515;
s = G__13516;
continue;
}
