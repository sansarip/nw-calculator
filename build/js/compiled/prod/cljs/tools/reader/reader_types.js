...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14711 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14711(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14712 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14712(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14713 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14713(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14714 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14714(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14715 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14715(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14716 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14716(reader);
}
});
...
var G__14727 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14728 = s.append(c);
c = G__14727;
s = G__14728;
continue;
}
