...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14112 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14112(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14113 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14113(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14114 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14114(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14115 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14115(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14116 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14116(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14117 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14117(reader);
}
});
...
var G__14128 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14129 = s.append(c);
c = G__14128;
s = G__14129;
continue;
}
