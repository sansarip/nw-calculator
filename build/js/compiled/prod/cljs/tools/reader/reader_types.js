...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15410 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15410(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15411 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15411(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15412 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15412(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15413 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15413(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15414 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15414(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15415 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15415(reader);
}
});
...
var G__15426 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15427 = s.append(c);
c = G__15426;
s = G__15427;
continue;
}
