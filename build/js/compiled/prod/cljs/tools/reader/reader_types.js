...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14740 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14740(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14741 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14741(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14742 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14742(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14743 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14743(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14744 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14744(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14745 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14745(reader);
}
});
...
var G__14756 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14757 = s.append(c);
c = G__14756;
s = G__14757;
continue;
}
