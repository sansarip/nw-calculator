...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__22349){
var map__22350 = p__22349;
var map__22350__$1 = cljs.core.__destructure_map(map__22350);
var ast = map__22350__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22350__$1,cljs.core.cst$kw$op);
return cljs.core.boolean$((function (){var and__4210__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__4210__auto__){
var G__22352 = (function (){var or__4212__auto__ = cljs.core.cst$kw$tag.cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__22353 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$var,null,cljs.core.cst$kw$local,null], null), null);
return (fexpr__22353.cljs$core$IFn$_invoke$arity$1 ? fexpr__22353.cljs$core$IFn$_invoke$arity$1(op) : fexpr__22353.call(null,op));
})())){
...
var fexpr__22351 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$sym$seq,"null",cljs.core.cst$sym$boolean,"null"], null), null);
return (fexpr__22351.cljs$core$IFn$_invoke$arity$1 ? fexpr__22351.cljs$core$IFn$_invoke$arity$1(G__22352) : fexpr__22351.call(null,G__22352));
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__22354_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(p1__22354_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__22355 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$env,cljs.core.cst$kw$locals], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__22355,local);
} else {
return G__22355;
}
});
...
var map__22356 = cljs.core.first(cljs.core.cst$kw$bindings.cljs$core$IFn$_invoke$arity$1(ast));
var map__22356__$1 = cljs.core.__destructure_map(map__22356);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22356__$1,cljs.core.cst$kw$init);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22356__$1,cljs.core.cst$kw$name);
...
var map__22357 = cljs.core.first(cljs.core.cst$kw$bindings.cljs$core$IFn$_invoke$arity$1(ast));
var map__22357__$1 = cljs.core.__destructure_map(map__22357);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22357__$1,cljs.core.cst$kw$init);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22357__$1,cljs.core.cst$kw$name);
