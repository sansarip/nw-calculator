...
nw_calculator.components.multiplication.styles.multiplication_class_factory$ = (function nw_calculator$components$multiplication$styles$multiplication_class_factory$(style_name29199,params29200){
var style29202 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [[".",cljs.core.str.cljs$core$IFn$_invoke$arity$1(style_name29199)].join(''),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input$basic_DASH_input$multiplier,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$width,cljs.core.cst$kw$100_PERCENT_,cljs.core.cst$kw$bottom,cljs.core.cst$kw$4$5rem], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input$basic_DASH_input$product,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$border,cljs.core.cst$kw$0px,cljs.core.cst$kw$padding,nw_calculator.styles.with_config("{{sizes.relative.4}} 0px 0px 0px")], null)], null)], null);
return new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$css,spade.runtime.compile_css(style29202),cljs.core.cst$kw$name,style_name29199], null);
});

var factory_name29201_29204 = spade.util.factory__GT_name(nw_calculator.components.multiplication.styles.multiplication_class_factory$);
...
return spade.runtime.ensure_style_BANG_(cljs.core.cst$kw$class,factory_name29201_29204,nw_calculator.components.multiplication.styles.multiplication_class_factory$,cljs.core.PersistentVector.EMPTY);
});
