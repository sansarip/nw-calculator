...
nw_calculator.components.multiplication.component.multiplication = (function nw_calculator$components$multiplication$component$multiplication(p__29252){
var map__29253 = p__29252;
var map__29253__$1 = cljs.core.__destructure_map(map__29253);
var map__29254 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29253__$1,cljs.core.cst$kw$input_DASH_props);
var map__29254__$1 = cljs.core.__destructure_map(map__29254);
var input_props = map__29254__$1;
var on_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29254__$1,cljs.core.cst$kw$on_DASH_input);
var base = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29253__$1,cljs.core.cst$kw$base);
var container_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29253__$1,cljs.core.cst$kw$container_DASH_props);
var vec__29255 = nw_calculator.components.multiplication.component.global$module$react.useState((1));
var multiplier = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29255,(0),null);
var set_multiplier_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29255,(1),null);
var input_ref = nw_calculator.components.multiplication.component.global$module$react.useRef();
var with_let29258 = reagent.ratom.with_let_values(cljs.core.cst$kw$with_DASH_let29258);
var temp__5757__auto___29265 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___29265 == null)){
} else {
var c__13075__auto___29266 = temp__5757__auto___29265;
if((with_let29258.generation === c__13075__auto___29266.ratomGeneration)){
...
(with_let29258.generation = c__13075__auto___29266.ratomGeneration);
}

var init29259 = (with_let29258.length === (0));
var on_input_STAR_ = ((((init29259) || (cljs.core.not(with_let29258.hasOwnProperty((0))))))?(with_let29258[(0)] = (function (event){
var G__29261_29267 = nw_calculator.utilities.parse_pos.cljs$core$IFn$_invoke$arity$1(event.target.value);
(set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1(G__29261_29267) : set_multiplier_BANG_.call(null,G__29261_29267));

return (on_input.cljs$core$IFn$_invoke$arity$1 ? on_input.cljs$core$IFn$_invoke$arity$1(event) : on_input.call(null,event));
})):(with_let29258[(0)]));
var res29260 = (function (){
var G__29262_29268 = (function (){
var temp__5753__auto___29270 = input_ref.current;
if(cljs.core.truth_(temp__5753__auto___29270)){
var input_ele_29271 = temp__5753__auto___29270;
var G__29264_29272 = nw_calculator.utilities.parse_pos.cljs$core$IFn$_invoke$arity$1(input_ele_29271.defaultValue);
(set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1(G__29264_29272) : set_multiplier_BANG_.call(null,G__29264_29272));
} else {
}

return nw_calculator.utilities.no_op;
});
var G__29263_29269 = [input_ref];
nw_calculator.components.multiplication.component.global$module$react.useEffect(G__29262_29268,G__29263_29269);
