...
nw_calculator.components.multiplication.component.multiplication = (function nw_calculator$components$multiplication$component$multiplication(p__31040){
var map__31041 = p__31040;
var map__31041__$1 = cljs.core.__destructure_map(map__31041);
var map__31042 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31041__$1,cljs.core.cst$kw$input_DASH_props);
var map__31042__$1 = cljs.core.__destructure_map(map__31042);
var input_props = map__31042__$1;
var on_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31042__$1,cljs.core.cst$kw$on_DASH_input);
var base = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31041__$1,cljs.core.cst$kw$base);
var container_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31041__$1,cljs.core.cst$kw$container_DASH_props);
var vec__31043 = nw_calculator.components.multiplication.component.global$module$react.useState((1));
var multiplier = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31043,(0),null);
var set_multiplier_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31043,(1),null);
var input_ref = nw_calculator.components.multiplication.component.global$module$react.useRef();
var with_let31046 = reagent.ratom.with_let_values(cljs.core.cst$kw$with_DASH_let31046);
var temp__5757__auto___31053 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___31053 == null)){
} else {
var c__14347__auto___31054 = temp__5757__auto___31053;
if((with_let31046.generation === c__14347__auto___31054.ratomGeneration)){
...
(with_let31046.generation = c__14347__auto___31054.ratomGeneration);
}

var init31047 = (with_let31046.length === (0));
var on_input_STAR_ = ((((init31047) || (cljs.core.not(with_let31046.hasOwnProperty((0))))))?(with_let31046[(0)] = (function (event){
var G__31049_31055 = nw_calculator.utilities.parse_pos.cljs$core$IFn$_invoke$arity$1(event.target.value);
(set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1(G__31049_31055) : set_multiplier_BANG_.call(null,G__31049_31055));

return (on_input.cljs$core$IFn$_invoke$arity$1 ? on_input.cljs$core$IFn$_invoke$arity$1(event) : on_input.call(null,event));
})):(with_let31046[(0)]));
var res31048 = (function (){
var G__31050_31056 = (function (){
var temp__5753__auto___31058 = input_ref.current;
if(cljs.core.truth_(temp__5753__auto___31058)){
var input_ele_31059 = temp__5753__auto___31058;
var G__31052_31060 = nw_calculator.utilities.parse_pos.cljs$core$IFn$_invoke$arity$1(input_ele_31059.defaultValue);
(set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1(G__31052_31060) : set_multiplier_BANG_.call(null,G__31052_31060));
} else {
}

return nw_calculator.utilities.no_op;
});
var G__31051_31057 = [input_ref];
nw_calculator.components.multiplication.component.global$module$react.useEffect(G__31050_31056,G__31051_31057);
