...
nw_calculator.components.multiplication.component.multiplication = (function nw_calculator$components$multiplication$component$multiplication(p__31028){
var map__31029 = p__31028;
var map__31029__$1 = cljs.core.__destructure_map(map__31029);
var map__31030 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31029__$1,cljs.core.cst$kw$input_DASH_props);
var map__31030__$1 = cljs.core.__destructure_map(map__31030);
var input_props = map__31030__$1;
var on_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31030__$1,cljs.core.cst$kw$on_DASH_input);
var base = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31029__$1,cljs.core.cst$kw$base);
var container_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31029__$1,cljs.core.cst$kw$container_DASH_props);
var vec__31031 = nw_calculator.components.multiplication.component.global$module$react.useState((1));
var multiplier = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31031,(0),null);
var set_multiplier_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31031,(1),null);
var input_ref = nw_calculator.components.multiplication.component.global$module$react.useRef();
var with_let31034 = reagent.ratom.with_let_values(cljs.core.cst$kw$with_DASH_let31034);
var temp__5757__auto___31041 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___31041 == null)){
} else {
var c__14347__auto___31042 = temp__5757__auto___31041;
if((with_let31034.generation === c__14347__auto___31042.ratomGeneration)){
...
(with_let31034.generation = c__14347__auto___31042.ratomGeneration);
}

var init31035 = (with_let31034.length === (0));
var on_input_STAR_ = ((((init31035) || (cljs.core.not(with_let31034.hasOwnProperty((0))))))?(with_let31034[(0)] = (function (event){
var G__31037_31043 = nw_calculator.utilities.parse_pos.cljs$core$IFn$_invoke$arity$1(event.target.value);
(set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1(G__31037_31043) : set_multiplier_BANG_.call(null,G__31037_31043));

return (on_input.cljs$core$IFn$_invoke$arity$1 ? on_input.cljs$core$IFn$_invoke$arity$1(event) : on_input.call(null,event));
})):(with_let31034[(0)]));
var res31036 = (function (){
var G__31038_31044 = (function (){
var temp__5753__auto___31046 = input_ref.current;
if(cljs.core.truth_(temp__5753__auto___31046)){
var input_ele_31047 = temp__5753__auto___31046;
var G__31040_31048 = nw_calculator.utilities.parse_pos.cljs$core$IFn$_invoke$arity$1(input_ele_31047.defaultValue);
(set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_multiplier_BANG_.cljs$core$IFn$_invoke$arity$1(G__31040_31048) : set_multiplier_BANG_.call(null,G__31040_31048));
} else {
}

return nw_calculator.utilities.no_op;
});
var G__31039_31045 = [input_ref];
nw_calculator.components.multiplication.component.global$module$react.useEffect(G__31038_31044,G__31039_31045);
