...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12760 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12760(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12761 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12761(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12762 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12762(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12763 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12763(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12764 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12764(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12765 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12765(reader);
}
});
...
var G__12776 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12777 = s.append(c);
c = G__12776;
s = G__12777;
continue;
}
