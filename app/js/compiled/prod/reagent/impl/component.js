...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__18328 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__18328);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__18329 = c;
var G__18329__$1 = (((G__18329 == null))?null:G__18329.prototype);
if((G__18329__$1 == null)){
return null;
} else {
return G__18329__$1.reagentRender;
}
})() == null)))));
});
...
var or__4212__auto__ = (function (){var G__18338 = c;
var G__18338__$1 = (((G__18338 == null))?null:G__18338.constructor);
if((G__18338__$1 == null)){
return null;
} else {
return G__18338__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__18340 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__18341 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__18341);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__18340);
}});
...
var c = this;
var G__18344_18346 = goog.object.get(c,"cljsRatom");
if((G__18344_18346 == null)){
} else {
reagent.ratom.dispose_BANG_(G__18344_18346);
}
...
var renders_18347 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_18348 = cljs.core.first(cljs.core.vals(renders_18347));
...
if((cljs.core.count(renders_18347) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_18347))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_18348)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_18348], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__18349 = o;
goog.object.set(G__18349,cljs.core.name(k),v);
...
return (function() { 
var G__18350__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__18351__i < G__18351__a.length) {G__18351__a[G__18351__i] = arguments[G__18351__i + 0]; ++G__18351__i;}
  args = new cljs.core.IndexedSeq(G__18351__a,0,null);
} 
return G__18350__delegate.call(this,args);};
...
return G__18350__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__18355 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__18356 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__18356);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__18355);
}});
...
var vec__18357 = reagent.impl.component.global$module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18357,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18357,(1),null);
...
var G__18360_18363 = (function reagent$impl$component$functional_render_$_mount(){
return (function reagent$impl$component$functional_render_$_mount_$_unmount(){
var G__18362 = goog.object.get(reagent_state,"cljsRatom");
if((G__18362 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__18362);
}
});
});
var G__18361_18364 = [];
reagent.impl.component.global$module$react.useEffect(G__18360_18363,G__18361_18364);
