...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__21022){
var map__21023 = p__21022;
var map__21023__$1 = cljs.core.__destructure_map(map__21023);
var ast = map__21023__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21023__$1,cljs.core.cst$kw$op);
return cljs.core.boolean$((function (){var and__4210__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__4210__auto__){
var G__21025 = (function (){var or__4212__auto__ = cljs.core.cst$kw$tag.cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__21026 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$var,null,cljs.core.cst$kw$local,null], null), null);
return (fexpr__21026.cljs$core$IFn$_invoke$arity$1 ? fexpr__21026.cljs$core$IFn$_invoke$arity$1(op) : fexpr__21026.call(null,op));
})())){
...
var fexpr__21024 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$sym$seq,"null",cljs.core.cst$sym$boolean,"null"], null), null);
return (fexpr__21024.cljs$core$IFn$_invoke$arity$1 ? fexpr__21024.cljs$core$IFn$_invoke$arity$1(G__21025) : fexpr__21024.call(null,G__21025));
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__21027_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(p1__21027_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__21028 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$env,cljs.core.cst$kw$locals], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__21028,local);
} else {
return G__21028;
}
});
...
var map__21029 = cljs.core.first(cljs.core.cst$kw$bindings.cljs$core$IFn$_invoke$arity$1(ast));
var map__21029__$1 = cljs.core.__destructure_map(map__21029);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21029__$1,cljs.core.cst$kw$init);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21029__$1,cljs.core.cst$kw$name);
...
var map__21030 = cljs.core.first(cljs.core.cst$kw$bindings.cljs$core$IFn$_invoke$arity$1(ast));
var map__21030__$1 = cljs.core.__destructure_map(map__21030);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21030__$1,cljs.core.cst$kw$init);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21030__$1,cljs.core.cst$kw$name);
