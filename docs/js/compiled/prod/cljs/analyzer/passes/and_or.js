...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__21720){
var map__21721 = p__21720;
var map__21721__$1 = cljs.core.__destructure_map(map__21721);
var ast = map__21721__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21721__$1,cljs.core.cst$kw$op);
return cljs.core.boolean$((function (){var and__4210__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__4210__auto__){
var G__21723 = (function (){var or__4212__auto__ = cljs.core.cst$kw$tag.cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__21724 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$var,null,cljs.core.cst$kw$local,null], null), null);
return (fexpr__21724.cljs$core$IFn$_invoke$arity$1 ? fexpr__21724.cljs$core$IFn$_invoke$arity$1(op) : fexpr__21724.call(null,op));
})())){
...
var fexpr__21722 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$sym$seq,"null",cljs.core.cst$sym$boolean,"null"], null), null);
return (fexpr__21722.cljs$core$IFn$_invoke$arity$1 ? fexpr__21722.cljs$core$IFn$_invoke$arity$1(G__21723) : fexpr__21722.call(null,G__21723));
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__21725_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(p1__21725_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__21726 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$env,cljs.core.cst$kw$locals], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__21726,local);
} else {
return G__21726;
}
});
...
var map__21727 = cljs.core.first(cljs.core.cst$kw$bindings.cljs$core$IFn$_invoke$arity$1(ast));
var map__21727__$1 = cljs.core.__destructure_map(map__21727);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21727__$1,cljs.core.cst$kw$init);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21727__$1,cljs.core.cst$kw$name);
...
var map__21728 = cljs.core.first(cljs.core.cst$kw$bindings.cljs$core$IFn$_invoke$arity$1(ast));
var map__21728__$1 = cljs.core.__destructure_map(map__21728);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21728__$1,cljs.core.cst$kw$init);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21728__$1,cljs.core.cst$kw$name);
