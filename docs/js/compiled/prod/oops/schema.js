...
var G__26563 = cljs.core.first(element_str);
switch (G__26563) {
case "?":
arr.push((1));
...
var G__26565 = cljs.core.next(items);
items = G__26565;
continue;
} else {
return null;
...
var G__26566 = cljs.core.next(items);
items = G__26566;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__26568 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__26568) : is_valid_QMARK_.call(null,G__26568));
})())){
var G__26569 = cljs.core.next(cljs.core.next(items));
items = G__26569;
continue;
} else {
return true;
...
switch (G__26572) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__26570_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26570_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__26571_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26571_SHARP_,(1));
})))){
