...
var G__12639 = format;
var G__12639__$1 = (((G__12639 instanceof cljs.core.Keyword))?G__12639.fqn:null);
switch (G__12639__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__12641 = cljs.core.second(format);
var G__12642 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__12641,G__12642) : ajax.easy.keyword_response_format_element.call(null,G__12641,G__12642));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12645_SHARP_){
return ajax.easy.keyword_response_format_element(p1__12645_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__12646){
var map__12647 = p__12646;
var map__12647__$1 = cljs.core.__destructure_map(map__12647);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12647__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12647__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12647__$1,cljs.core.cst$kw$finally);
...
return (function ajax$easy$transform_handler_$_easy_handler(p__12648){
var vec__12649 = p__12648;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12649,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12649,(1),null);
var fexpr__12652_12653 = (cljs.core.truth_(ok)?h:e);
(fexpr__12652_12653.cljs$core$IFn$_invoke$arity$1 ? fexpr__12652_12653.cljs$core$IFn$_invoke$arity$1(result) : fexpr__12652_12653.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__12654){
var map__12655 = p__12654;
var map__12655__$1 = cljs.core.__destructure_map(map__12655);
var opts = map__12655__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12655__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12655__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12655__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12655__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12655__$1,cljs.core.cst$kw$body);
