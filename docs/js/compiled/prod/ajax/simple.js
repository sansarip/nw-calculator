...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__13129){
var map__13130 = p__13129;
var map__13130__$1 = cljs.core.__destructure_map(map__13130);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13130__$1,cljs.core.cst$kw$handler);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,cljs.core.cst$kw$method,ajax.simple.normalize_method),cljs.core.cst$kw$interceptors,(function (p1__13131_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4212__auto__ = p1__13131_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__13132){
var map__13133 = p__13132;
var map__13133__$1 = cljs.core.__destructure_map(map__13133);
var request = map__13133__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13133__$1,cljs.core.cst$kw$interceptors);
