...
var G__14206 = request;
var G__14207 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__14206,G__14207) : ajax.formats.get_format.call(null,G__14206,G__14207));
} else {
...
return cljs.core.some((function (p1__14208_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__14208_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__14209){
var map__14210 = p__14209;
var map__14210__$1 = cljs.core.__destructure_map(map__14210);
var request = map__14210__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14210__$1,cljs.core.cst$kw$response_DASH_format);
...
var fexpr__14211 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__14211.cljs$core$IFn$_invoke$arity$1 ? fexpr__14211.cljs$core$IFn$_invoke$arity$1(response) : fexpr__14211.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__14213){
var map__14214 = p__14213;
var map__14214__$1 = cljs.core.__destructure_map(map__14214);
var request = map__14214__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14214__$1,cljs.core.cst$kw$response_DASH_format);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__14212_SHARP_){
return ajax.formats.get_accept_entries(request,p1__14212_SHARP_);
