...
var G__12388 = request;
var G__12389 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__12388,G__12389) : ajax.formats.get_format.call(null,G__12388,G__12389));
} else {
...
return cljs.core.some((function (p1__12390_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__12390_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12391){
var map__12392 = p__12391;
var map__12392__$1 = cljs.core.__destructure_map(map__12392);
var request = map__12392__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12392__$1,cljs.core.cst$kw$response_DASH_format);
...
var fexpr__12393 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12393.cljs$core$IFn$_invoke$arity$1 ? fexpr__12393.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12393.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__12395){
var map__12396 = p__12395;
var map__12396__$1 = cljs.core.__destructure_map(map__12396);
var request = map__12396__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12396__$1,cljs.core.cst$kw$response_DASH_format);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__12394_SHARP_){
return ajax.formats.get_accept_entries(request,p1__12394_SHARP_);
