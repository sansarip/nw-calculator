...
re_frame.settings.reg_global_interceptor = (function re_frame$settings$reg_global_interceptor(p__19135){
var map__19136 = p__19135;
var map__19136__$1 = cljs.core.__destructure_map(map__19136);
var interceptor = map__19136__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19136__$1,cljs.core.cst$kw$id);
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(re_frame.settings.store,cljs.core.update,cljs.core.cst$kw$global_DASH_interceptors,(function (global_interceptors){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_frame.interop.empty_queue,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__19137_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__19137_SHARP_));
}),global_interceptors));
}));
}));
